...
const Home = () => {
  ...
  return (
    <div className="h-[70vh] flex flex-col gap-10 items-center justify-center mt-auto mb-auto opacity-0 max-sm:ml-4 max-sm:mt-28 " id="heading">
     <h1 className="flex gap-3 text-3xl text-white tracking-widest max-sm:flex-col">Hi, I{"'"}m <span className="text-amber-600 translate-x-[100px]  name">Aman Dhungel</span></h1>
     <hr className="border-amber-500 w-[20rem]" id="hrtag"/>
     <div className="flex flex-col gap-10">
      ...
      <div className="flex gap-28 max-sm:gap-5 max-sm:ml-3">
     ...
     <div className="flex gap-10 translate-x-[100px] opacity-0 max-sm:flex-col" id="buttons">
      <Link to={'/about'} className="rounded-xl text-xl text-white text-center bg-slate-900 p-5 tracking-widest w-[15rem] hover:bg-slate-800 transition-all shadow-lg shadow-slate-500">About Me</Link>
      <a href={pdf} className="rounded-xl text-xl text-white bg-slate-900 tracking-wider p-5 w-[15rem] shadow-lg shadow-slate-500  hover:bg-slate-800 transition-all">Download Resume</a>
     </div>
    </div>
  )
}
